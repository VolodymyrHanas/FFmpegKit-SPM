...
FFMPEG_KIT_REPO="https://github.com/VolodymyrHanas/ffmpeg-kit"
...
./ios.sh --disable-armv7 --disable-armv7s --disable-arm64-mac-catalyst --disable-arm64e --disable-i386 --disable-x86-64 --disable-x86-64-mac-catalyst --enable-ios-audiotoolbox  --enable-ios-avfoundation --enable-ios-videotoolbox --no-bitcode --target=17.0 -x
